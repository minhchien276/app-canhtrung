...
class BabyAddWidget extends StatefulWidget {
  static const routeName = 'baby-add-widget';
  BabyAddWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<BabyAddWidget> createState() => _BabyAddWidgetState();
}

class _BabyAddWidgetState extends State<BabyAddWidget> {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          BlocBuilder<MilkBloc, MilkState>(
                        ...
                        children: [
                          ...
                          KLoaderButton(
                            onTap: () {
                              ...
                              if (check == null) {
                                context.read<MilkBloc>().add(AddBabyEvent(
                                        con: Con(
                                      id: 0,
